...
func genSegments(offsets ...int64) []Segment[index.NoIndex, index.NoItem, struct{}, *index.NoIndexRuntime] {
	var segments []Segment[index.NoIndex, index.NoItem, struct{}, *index.NoIndexRuntime]
