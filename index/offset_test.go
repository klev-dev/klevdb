...
func TestConsume(t *testing.T) {
	var tests = []struct {
		...
		{items: []int64{1}, offset: 0, position: 1},
		...
		{items: []int64{1, 2, 3}, offset: 0, position: 1},
		...
		{items: []int64{1, 3}, offset: 0, position: 1},
		{items: []int64{1, 3}, offset: 1, position: 1},
		{items: []int64{1, 3}, offset: 2, position: 3},
		...
		{items: []int64{1, 3, 5}, offset: 0, position: 1},
		{items: []int64{1, 3, 5}, offset: 1, position: 1},
		{items: []int64{1, 3, 5}, offset: 2, position: 3},
		{items: []int64{1, 3, 5}, offset: 3, position: 3},
		{items: []int64{1, 3, 5}, offset: 4, position: 5},
	...
	for _, tc := range tests {
		t.Run(fmt.Sprintf("%v:%d", tc.items, tc.offset), func(t *testing.T) {
			position, err := Consume(genItems(tc.items...), tc.offset)
